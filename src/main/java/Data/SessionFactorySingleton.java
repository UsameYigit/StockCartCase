...
public class SessionFactorySingleton {
	...
	//A method where if it's null an isntace is created for sessionFactory 
	public static synchronized  SessionFactory getSessionFactory() {
		if(sessionFactory == null) {
			try {
				...
				sessionFactory = new Configuration().configure(".\\hibernate.cfg.xml").addAnnotatedClass(StockCart.class).
	                    buildSessionFactory();
			}
